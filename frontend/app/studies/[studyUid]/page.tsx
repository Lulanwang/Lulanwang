          ...
          <div className="bg-amber-50 border border-amber-300 rounded p-3">
            <div className="flex items-center justify-between mb-2">
              <h3 className="font-semibold text-sm">
                Clinical narrative
                <span className="ml-2 text-[10px] uppercase font-normal text-amber-800 bg-amber-200 px-1.5 py-0.5 rounded">
                  MedGemma · experimental
                </span>
              </h3>
            </div>
            ...
            <div className="mt-3 border-t border-amber-200 pt-2 text-[10px] text-amber-900">
              <div>
                Generated by <code className="font-mono">{report.narrative_model || "?"}</code>
                {report.narrative_generated_at && (
                  <> at {new Date(report.narrative_generated_at).toLocaleString()}</>
                )}
              </div>
              <div className="mt-1 font-semibold">
                RESEARCH USE ONLY — unverified — radiologist must review before clinical use.
              </div>
            </div>
          </div>
        )}
